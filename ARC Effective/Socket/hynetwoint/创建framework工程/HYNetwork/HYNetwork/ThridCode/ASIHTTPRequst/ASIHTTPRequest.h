...
@property (nonatomic, retain) HYNetworkData* networkData;

@property (assign) CGFloat uploadProgress;
@property (assign) CGFloat downloadProgress;

@property (assign) BOOL queueNumber;

@property (assign) NSInteger bytesSentNum;
@property (assign) NSInteger bytesSentZeroNum;
