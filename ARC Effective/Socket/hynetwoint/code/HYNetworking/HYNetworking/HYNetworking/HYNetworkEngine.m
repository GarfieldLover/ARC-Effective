...
-(id)init
{
    ...
    if(self){
        ...
        removeDataIndex=0;
        [self performSelector:@selector(uploadLog) withObject:Nil afterDelay:30];
        [NSTimer scheduledTimerWithTimeInterval:60*6 target:self selector:@selector(uploadLog) userInfo:Nil repeats:YES];
    }
    return self; 
}
